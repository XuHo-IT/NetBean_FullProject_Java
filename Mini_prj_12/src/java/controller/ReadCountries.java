...
public class ReadCountries extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ReadCountries</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ReadCountries at " +
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Country> countries = countryService.findCountries(currentPage, recordsPerPage);
